...
<div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Silahkan update category yang di inginkan</p>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="Masukkan Nama category" name="cat_name" required value="{{$category->cat_name}}">
                        </div>
                        ...
                        <div class="form-group d-flex justify-content-end">
                            ...
                            <a href="{{ route('category.index') }}" type="submit" class="btn btn-light-secondary me-1 mb-1">Batal</a>
                        </div>
                    </div>
                </div>
            </div>
