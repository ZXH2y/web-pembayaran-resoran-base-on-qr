...
<div class="container-fluid fruite py-5 d-flex justify-content-center">
    <div class="receipt border p-4 bg-white shadow" style="width: 450px; margin-top: 5rem">
            <h5 class="text-center mb-2"> Pesanan berhasil di buat!</h5>
        ...
        @elseif($order->payment_method == 'qris' && $order->status == 'success')
            <p class="text-center"><span class="badge bg-success">Menunggu konfirmasi pembayaran</span></p>
        @else
            <p class="text-center"><span class="badge bg-success">Pembayaran Berhasil, pemesanan segera di proses</span></p>
        @endif
        <hr>
        ...
        @if($order->payment_method == 'tunai')
            <p class="small text-center"> Tunjukkan kode bayar ini untuk menyelesaikan pembayaran</p>
        @elseif($order->payment_method == 'qris')
            <p class="small text-center"> Yeay pembayaran sukses, pesanan kami proses</p>
        @endif
        <hr>
